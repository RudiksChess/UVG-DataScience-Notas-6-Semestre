...
\textsc{\Large CC3066 - 2 semestre - 2021}\\[0.8cm]
\MSonehalfspacing
\textsc{Licenciatura en matemática aplicada}\\[1.0cm]

\HRule\\[1.4cm]
\MSdoublespacing
{ \huge \bfseries DATA SCIENCE 1}\\[0.2cm]
{ \large Catedrático: Luis Furlán }\\[0.3cm] % Falls nicht benötigt, einfach auskommentieren
\HRule \\[2.4cm]
\MSonehalfspacing
